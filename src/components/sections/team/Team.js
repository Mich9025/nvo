            ...
            <div className="team__left__wrap">
              ...
              >
                <div className="section__title__heading">
                  <h3>COBERTURA NACIONAL EN 12+ CIUDADES.</h3>
                </div>
                <div className="section__title__text">
                  <p>
                    Bogotá, Medellín, Cali, Manizales, Pereira, Armenia, Santa Marta, 
                    Cartagena, Barranquilla, Santander, Villavicencio e Ibagué.
                  </p>
                </div>
              </div>
